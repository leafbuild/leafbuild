...
pub fn generate_parser_tests() -> io::Result<()> {
...
pub fn install_tests(tests: Vec<ParseTest>) -> io::Result<()> {
...
pub fn run_tests(args: Vec<String>) -> CmdResult {
    cargo_cmd!(format!("test {}", args.join(" ")))
}
